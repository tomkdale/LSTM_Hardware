...
HD_PWD='C:/Users/tdale19/Desktop/LSTMsingle/LSTMsingle.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LSTMtop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LSTMtop.tcl -notrace
